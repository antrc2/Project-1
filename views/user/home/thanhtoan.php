              ...
              <ul class="list-group mb-3">
                <?php foreach ($cartDetailByCartId as $cart): ?>
                  <li class="list-group-item d-flex justify-content-between lh-condensed">
                    ...
                    <span class="text-muted"><?= number_format($cart['cart_detail_price'] * $cart['cart_detail_amount']) ?> đ</span>
                  </li>
                <?php endforeach ?>
                ...
                <div class="row">
                  <div class="col-md-6 col">
                    <div class="form-floating">
                      <input type="text" class="form-control" id="name" name="fullname" placeholder="Your Name" value="<?= $userInfo['fullname'] ?>"
                        required>
                  ...
                  <div class="col-md-6 col">
                    <div class="form-floating">
                      <input type="address" class="form-control" id="address" name="address" placeholder="Address" value="<?= $userInfo['address'] ?>"
                        required>
                  ...
                  <div class="col-md-6 col">
                    <div class="form-floating">
                      <input type="text" class="form-control" id="sdt" name="phone" placeholder="Số điện thoại" value="<?= $userInfo['phone'] ?>"
                        required>
                  ...
                  <div class="col-md-6 col">
                    <div class="form-floating">
                      <input type="email" class="form-control" id="email" name="email" placeholder="Your Email" value="<?= $userInfo['email'] ?>"
                        required>
